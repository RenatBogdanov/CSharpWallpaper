...
namespace CSharpWallpaper.ViewModels
{
    ...
    {
        // Инициализируем списки сразу, чтобы не было предупреждений и ошибок NullReference
        public List<SimpleImageCardViewModel> SimpleCards { get; set; } = new();
        public List<ImageTextCardViewModel> ImageTextCards { get; set; } = new();
        public List<ImageIconTextCardViewModel> IconCards { get; set; } = new();
    }
}
